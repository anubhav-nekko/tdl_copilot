...
;===============================================================================
; BOMWITEMPOSTING.TXT
; Purpose: Enables "Fill from BOM" in Stock Journal for auto-posting BOM items.
;===============================================================================

;------------------------------------------------------------------------------
; ADD "FILL FROM BOM" BUTTON TO STOCK JOURNAL
;------------------------------------------------------------------------------

[#form : stock Journal Color]
    add : option : cwBOMPostInSJ : ##UseBoM
...
;------------------------------------------------------------------------------
; VARIABLES AND COLLECTIONS FOR BOM POSTING
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; MAIN FUNCTION: FILL BOM ITEMS TO POST
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; RECURSIVE FUNCTION: CHECK AND INSERT BOM ITEMS
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLLECTIONS FOR BOM COMPONENTS
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; FUNCTION: POST ITEM TO INVENTORY ENTRIES
;------------------------------------------------------------------------------
...
[function : PostItem]
    ...
    0501 : if : $$tgtobject:$$IsStockJrnl:$Vouchertypename
        ...
        0504 : else
        0505 : Insert Collection Object : Inventory Entriesin
        0506 : end if
    ...
    0581: set value : BilledQty : if ##isInward then $$abs:$$asqty:##AQty else -1 *$$asqty:##AQty
    0591 : end block
