...
; Purpose: Adds barcode, MRP, image, and additional batch fields to Tally batch
;          and voucher lines, with company-level settings and UI enhancements.
;===============================================================================

;------------------------------------------------------------------------------
; COMPANY CONFIGURATION LINES FOR BATCH & BARCODE FEATURES
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; BATCH FIELD CAPTION CONFIGURATION LINE
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; SYSTEM FORMULAS FOR COMPANY-LEVEL FLAGS
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; SALES VOUCHER CHANGES: BARCODE, MRP, IMAGE, BATCH FIELDS
;------------------------------------------------------------------------------
...
[!Line: ColumnOneslx]
    add: Fields: before: VCH ItemTitle: snf, snf2
...
[#Line: ei invinfo]
    add: option: invinfoslx: @@cwvtypbarcodeitem
...
;------------------------------------------------------------------------------
; BATCH AND ITEM FIELD EXTENSIONS FOR VOUCHER LINES
;------------------------------------------------------------------------------

; (All batch and item field logic as per your original file, including image, MRP, and additional caption handling.)

;------------------------------------------------------------------------------
; IMAGE VIEWER SUBFORM
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; (All additional logic for batch, stock allocation, and voucher lines continues...)
;-------------------------------------------------------------------------------
