// Auto-generated from medicine.txt
const tdl = `
;;===============================================================================
;; MEDICINE.TXT
;; Client: [Confidential]
...
;; Purpose: Master include file for RoseHomeo/Medicine module in Tally.
;;          Integrates all dependencies, company config, UDFs, master changes,
;;          transaction changes, reports, and demo logic.
;;===============================================================================
...
;------------------------------------------------------------------------------
; SYSTEM FORMULAS: DEMO MODE & DATE LOGIC
;------------------------------------------------------------------------------
...
RoseHomeoSales : ($$issales:##svvouchertype or $$ispurchase:##svvouchertype)
...
[#Form: Company Operations]
    ; Version-based UI logic (NOTE: Switch is not valid TDL, use Add : Option for actual TDL)
     Add : Option : RoseHomeoNotFor3_2 : ($$Number:$$ProdInfo:ProdReleaseAsStr) < 3.2
     Add : Option : RoseHomeoFor3_2    : ($$Number:$$ProdInfo:ProdReleaseAsStr) >= 3.2

[#Form : RoseHomeoNOTFor3_2]
    Local: Part : CMP AccFeat Left : Add : Line : At End : RoseHomeoConfig

[#Form : RoseHomeoFor3_2]
...
;------------------------------------------------------------------------------
; INCLUDE UDFs, MASTER & TRANSACTION CHANGES, REPORTS
;------------------------------------------------------------------------------
...
;; [include : RatewisehsnSummaryReport2.txt]
