// Auto-generated from newsalesvoucherchanges.txt
const tdl = `
;===============================================================================
; NEWSALESVOUCHERCHANGES.TXT
; Created By: Khokan on 2014-06-02 14:10, ID:
; Purpose: Enhances batch and inventory info lines in vouchers for Rose Homeo,
;          adding group-level discount logic and custom "RM PCS" columns.
;===============================================================================

;------------------------------------------------------------------------------
; BATCH ALLOCATION: GROUP-LEVEL DISCOUNT LOGIC
;------------------------------------------------------------------------------
...
[!line: cwSTKVCH Batch2]
    add: right field: before: VCHBATCH Value: numf
...
;------------------------------------------------------------------------------
; INVENTORY INFO: GROUP-LEVEL DISCOUNT LOGIC
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLUMN TWO: ADD BLANK FIELD FOR ALIGNMENT
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; (OPTIONAL/COMMENTED) PCS FIELD IN INVENTORY INFO
;------------------------------------------------------------------------------
