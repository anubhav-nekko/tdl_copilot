// Auto-generated from stockmusterchanges.txt
const tdl = `
;===============================================================================
; STOCKMUSTERCHANGES.TXT
; Created By: Khokan on 2014-05-26 10:47, ID:
; Modified By: pg on 2012-04-18 11:20
; Purpose: Enables group-level discount settings for ledgers under Sundry Debtors,
;          providing a subform in the ledger master for setting multiple discounts
;          and credit days per stock group.
;===============================================================================

;------------------------------------------------------------------------------
; AGGREGATE DISCOUNT COLLECTION FOR LEDGERS
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; EXTEND LEDGER MASTER: DISCOUNT SETTING FOR SUNDRY DEBTORS
;------------------------------------------------------------------------------

[#Part: MST LED Explode Sundry]
    ;; Only activate for Sundry Debtors group
    ;; {11.Jun.14 13:03} add:option:cwMSTLEDExplodeSundry:@@ParentGroupReservedName = @@GroupSundryDebtors

[!PART:cwMSTLEDExplodeSundry]
...
;------------------------------------------------------------------------------
; DISCOUNT SUBFORM: SET MULTIPLE DISCOUNTS PER STOCK GROUP
;------------------------------------------------------------------------------
    ...
    [line: setdistitleline2]
        ...
        [System: Formula]
		IsStockGroupSysName : $$IsSysName:$cwSetStockGroup

		Local : Field : numf : Inactive : @@IsStockGroupSysName
