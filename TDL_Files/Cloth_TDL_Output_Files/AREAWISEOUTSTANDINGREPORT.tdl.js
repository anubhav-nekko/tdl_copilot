// Auto-generated from AREAWISEOUTSTANDINGREPORT.TXT
const tdl = `
;===============================================================================
; AREAWISEOUTSTANDINGREPORT.TXT
; Created By: Khokan on 2021-08-24 11:57, ID:
; Purpose: Provides an "Area Wise Outstanding Report" in Tally,
;          showing outstanding bills and credits for all areas/cost centres,
;          with filtering, split view, and totals.
;===============================================================================

[#menu: Gateway of Tally]
;; {24.Aug.21 19:26}         add: Option: AreaTWISEOutstandingReportLock ;; : @@AGENTWISEOutstandingReportDemoLock
...
[Report: SCostCentrex]
    ...
    Local: Line: Collection Variable: Field: SCostCentre
    Local: Field: MV Title: Info: $$LocaleString:"Name of Cost Centre"

    [Field: SCostCentrex]
        Use: Name Field
        Table: cwcaption3tableundercc
        Show Table: Always
...
[System: Formula]
    mycwcwcaption3table: $parent = @@cwcaption3tableundernew
    AreaTWISEOutstandingReportReport: @@cwcaption3tableundernew + " wise outstanding report"
...
[system: Formula]
    ColAreaTWISEOutstandingReportFilter: $$isdr:$closingbalance and $cwcaption3item:ledger:$parent = ##SCostCentre
...
[system: Formula]
    ColAreaTWISEOutstandingReportFilterb: not $$isdr:$closingbalance and $cwcaption3item:ledger:$parent = ##SCostCentre
