// Auto-generated from CRNOTEVOUCHERTYPE.TXT
const tdl = `
;===============================================================================
; CRNOTEVOUCHERTYPE.TXT
; Created By: khokan on 2022-04-29 12:24, ID:
; Purpose: Adds configuration options to Credit Note and Sales voucher types
;          in Tally for enabling "Sales Return Report" and "Net Sales Report"
;          when the Minu Saree module is active.
;===============================================================================
