// Auto-generated from TEST1X.TXT
const tdl = `
;===============================================================================
; TEST1X.TXT
; Created By: khokan on 2022-05-18 12:22, ID:
; Purpose: Implements a custom report "Colreceiptsalesman" in Tally, demonstrating
;          advanced grouping, aggregation, and filtering for receipt/salesman analysis.
;===============================================================================
...
;;------------------------------------------------------------------------------
;; MAIN DATA PART: Table of grouped and aggregated receipts/salesman data
;;------------------------------------------------------------------------------
...
;;------------------------------------------------------------------------------
;; DATA COLLECTION: Aggregates and groups receipts/sales for analysis
;;------------------------------------------------------------------------------
...
;;------------------------------------------------------------------------------
;; DATA LINE: Main line showing all calculated columns per receipt/salesman
;;------------------------------------------------------------------------------
...
[Line: LnColreceiptsalesman]
    ...
    local : field : nf1 : set as  :$cwcaption2vch1
    local : field : nf2 : set as  :$cwcaption3vch1
    local : field : nf  : set as  :$cwcaption2item1
    local : field : numf  : set as  :$salescrbilledqty
    local:field: amtf: set as:$$nettamount:#amtf12:#amtf13
    local:field: amtf12: set as:$$nettamount:$crnoteinvamt1:$cwcrnotediscamt1x
...
;===============================================================================
; End of TEST1X.TXT (with documentation comments)
;===============================================================================
