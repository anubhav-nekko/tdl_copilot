// Auto-generated from CRNOTEVOUCHER.TXT
const tdl = `
;===============================================================================
; CRNOTEVOUCHER.TXT
; Created By: Khokan on 2021-05-22 17:42, ID:
; Purpose: Customizes the Credit Note Voucher entry and print in Tally,
;          adding fields for "Fresh/Kata", "Additional Description", "Tax%", "Disc.",
;          and other item-level details, specifically when Minu Saree module is enabled.
;===============================================================================
