// Auto-generated from ALLZONEWISENETSALESREPORT.TXT
const tdl = `
;===============================================================================
; ALLZONEWISENETSALESREPORT.TXT
; Created By: Khokan on 2021-08-27 14:11, ID:
; Purpose: Provides an "All Zone Wise Net Sales Report" in Tally, showing
;          net sales, returns, and collections per party/zone, with filtering,
;          drilldown, and aggregation features.
;===============================================================================
...
[Line: LnallZONEWISEnetsalesReportTitle]
    ...
    option: titleopt
    local: field: fwf: set as: @@cwcaption4tableundernew
...
[Line: LnallAGENTWISEnetsalesreportTitle3]
    use: LnallZONEWISEnetsalesReport
    delete: explode
    local: field: fwf: set as: $$CollectionField:$cwcaption1vch4:First:ColallZONEWISEnetsalesReport
...
[line: expZoneWISEsalesRep]
    use: LnallZONEWISEnetsalesReport
    delete: explode
    local: field: fwf: set as: $$nextobj:$cwcaption1vch4
    local: field: nf: set as: ""
    local: field: numf: set as: ""
    local: field: numf2: set as: ""
    local: field: amtf: set as: ""
