// Auto-generated from COLUMNARSALESREGISTER.TXT
const tdl = `
;===============================================================================
; COLUMNARSALESREGISTER.TXT
; Created By: khokan on 2022-05-14 16:07, ID:
; Purpose: Extends the Columnar Sales Register in Tally to include custom
;          columns (caption fields) for enhanced reporting, specifically when
;          the voucher is a sales type and the Minu Saree module is enabled.
;===============================================================================
