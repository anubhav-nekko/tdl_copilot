// Auto-generated from ALLAREAWISENETSALESREPORT.TXT
const tdl = `
;===============================================================================
; ALLAREAWISENETSALESREPORT.TXT
; Created By: Khokan on 2021-08-27 14:37, ID:
; Purpose: Provides an "All Area Wise Net Sales Report" in Tally, showing
;          net sales, returns, and collections per party/area, with filtering,
...
;------------------------------------------------------------------------------
; MAIN REPORT DEFINITION: All Area Wise Net Sales Report
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; MAIN DATA PART: REPEAT LINES FOR EACH PARTY/AREA
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLLECTION: Aggregated net sales, returns, and collections by party/area
;------------------------------------------------------------------------------
...
[line: LnallAREAWISEnetsalesReportTitle3]
    use: LnallAREAWISEnetsalesReport
    delete: explode
    local: field: fwf: set as: $$CollectionField:$cwcaption1vch3:First:ColallAREAWISEnetsalesReport
...
;------------------------------------------------------------------------------
; MAIN DATA LINE: Area/party net sales, returns, collections, etc.
;------------------------------------------------------------------------------
