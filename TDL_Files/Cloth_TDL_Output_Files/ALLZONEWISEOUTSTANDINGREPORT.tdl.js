// Auto-generated from ALLZONEWISEOUTSTANDINGREPORT.TXT
const tdl = `
;===============================================================================
; ALLZONEWISEOUTSTANDINGREPORT.TXT
; Created By: Khokan on 2021-08-27 12:41, ID:
; Purpose: Provides an "All Zone Wise Outstanding Report" in Tally,
;          showing outstanding bills and credits for all zones/parties,
;          with filtering, split view (Dr/Cr), and totals.
;===============================================================================

[#menu: Gateway of Tally]
;; {27.Aug.21 13:33}         add: Option: ALLZONEWISEOutstandingReportLock ;; : @@ALLZONEWISEOutstandingReportDemoLock
...
[System: formula]
    ALLZONEWISEOutstandingReportReport: "All " + @@cwcaption4tableundernew + " wise outstanding report"
...
[Line: LnALLZONEWISEOutstandingReport]
    ...
    local: field: fwf: set as: $cwcaption4vch
