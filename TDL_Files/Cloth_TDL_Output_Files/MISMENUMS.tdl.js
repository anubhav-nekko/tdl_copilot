// Auto-generated from MISMENUMS.TXT
const tdl = `
;; Created By: Khokan on 2021-05-25 13:00
;; Entry Point: Adds MIS Menu to Gateway of Tally
...
;; NOTE: Following section is commented and left for legacy or reference purposes
/*
add: Item:@@supplierpartyaddressbookReportReport: Display Collection:collRepsupplierpartyaddressbookReport
add: Item: Blank
add: Item: Blank
...
;; LR and Logistics Related Reports
add: Item: @@LRPendingReportReport: alter: RepLRPendingReport
add: Item: Blank
add: Item:@@LrreportReport: Display: RepLrreport
add: Item: Blank

;; Additional Reports (commented with date stamps)
;; {30.Aug.21 11:46} Agent Wise Ageing
;; {02.Sep.21 16:10} Alternate Agent Wise Ageing
;; {16.Apr.22 14:46} Ageing Wise Outstanding
...
;; Sub Menu for Top Sales Products
...
;; Outstanding Report Menu with various groupings
[MENU:OutstandingReport]
add: Item:@@outstandingreportReport: Display Collection: collledos
add: Item: Blank
...
add: Item: Blank
add: Item: @@SALESMANWISEnetsalesreportnewReport: Display Collection: dispcolllRepSALESMANWISEnetsalesreportnew
add: Item: Blank
add: Item: @@allSALESMANWISEnetsalesreportnewReport: Display: RepallSALESMANWISEnetsalesreportnew
add: Item: Blank
add: Item:@@AREAWISEnetsalesReportnewReport: Display Collection: collRepAREAWISEnetsalesReportnew
add: Item: Blank
...
add: Item:@@PartywisesalesregisterreportReport: Display Collection: colllRepPartywisesalesregisterreport
add: Item: Blank
...
add: Item: Blank
add: Item: @@AREAWISEsalesregiterReportReport: Display Collection: collRepAREAWISEsalesregiterReport
add: Item: Blank
...
add: Item:@@partywisecollctionreportReport: Display Collection: colllReppartywisecollctionreport
add: Item: Blank
...
add: Item: Blank
add: Item: @@multiprintZONEWISEOutstandingReportReport: print Collection: collRepmultiprintZONEWISEOutstandingReport
add: Item: Blank
