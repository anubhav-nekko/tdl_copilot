// Auto-generated from ALLSALESMANWISESALESREGITERREPORT.TXT
const tdl = `
;===============================================================================
; ALLSALESMANWISESALESREGITERREPORT.TXT
; Created By: Khokan on 2021-08-27 15:59, ID:
; Purpose: Provides an "All Salesman Wise Sales Register Report" in Tally,
;          listing sales vouchers by salesman/party, with transport, area, LR details,
...
;------------------------------------------------------------------------------
; MAIN DATA PART: REPEAT LINES FOR EACH SALES VOUCHER/SALESMAN/PARTY
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLLECTION: Aggregates sales by salesman/party, date, voucher, etc.
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; MAIN DATA LINE: Sales voucher details per salesman/party
;------------------------------------------------------------------------------
