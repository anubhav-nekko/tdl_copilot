// Auto-generated from ALLAREAWISESALESRETURNREGITERREPORT.TXT
const tdl = `
;===============================================================================
; ALLAREAWISESALESRETURNREGITERREPORT.TXT
; Created By: khokan on 2022-04-27 12:59, ID:
; Purpose: Provides an "All Area Wise Sales Return Register Report" in Tally,
...
;; {29.Apr.22 09:45}         add: Option: AllAREAWISEsalesReturnregiterReportLock ;; : @@AllAREAWISEsalesReturnregiterReportDemoLock
...
[System: formula]
    AllAREAWISEsalesReturnregiterReportReport: "All Area wise sales return report"
...
;------------------------------------------------------------------------------
; MAIN DATA PART: REPEAT LINES FOR EACH AREA/PARTY
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLLECTION: Aggregates sales return by area/party
;------------------------------------------------------------------------------
...
[system: Formula]
    cwcaption1vch3fil: not $$isempty:$cwcaption1vch3
...
[Line: LnAllAREAWISEsalesReturnregiterReportTitle1]
    ...
    local: field: fwf: set as: $$CollectionField:$cwcaption1vch3:First:ColAllAREAWISEsalesReturnregiterReport
...
;------------------------------------------------------------------------------
; MAIN DATA LINE: Sales return details per area/party
;------------------------------------------------------------------------------
...
add: explode: expAREAWISEsalesRetur: $$line = $$numitems or $cwcaption1vch3 <> $$nextobj:$cwcaption1vch3
...
[line: expAREAWISEsalesRetur]
    use: LnAllAREAWISEsalesReturnregiterReport
    delete: explode
    local: field: fwf: set as: $$nextobj:$cwcaption1vch3
...
[line: expAREAWISEsalesRetursubtotal]
    use: LnAllAREAWISEsalesReturnregiterReport
    delete: explode
    local: field: fwf: set as: "Area Total"
    local: field: nf: set as: ""
