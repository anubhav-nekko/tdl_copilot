// Auto-generated from CITYWISESALESREGISTERREPORT.TXT
const tdl = `
;===============================================================================
; CITYWISESALESREGISTERREPORT.TXT
; Created By: Khokan on 2021-08-26 19:37, ID:
; Purpose: Provides a "City Wise Sales Register Report" in Tally,
;          listing sales vouchers by city/party, with transport, area, LR details,
;          quantities, and gross amounts, including totals.
;===============================================================================

[#menu: Gateway of Tally]
;; {26.Aug.21 19:45}         add: Option: CitywisesalesregisterreportLock ;; : @@CitywisesalesregisterreportDemoLock
