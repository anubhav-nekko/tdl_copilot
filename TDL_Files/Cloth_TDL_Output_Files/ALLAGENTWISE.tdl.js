// Auto-generated from ALLAGENTWISE.TXT
const tdl = `
;===============================================================================
; ALLAGENTWISE.TXT
; Created By: khokan on 2022-04-16 15:05, ID:
; Created By: Khokan on 2018-12-11 18:29, ID:
; Purpose: Provides an "Ageing Wise Outstanding (All Agent wise)" report in Tally,
;          summarizing outstanding balances for all agents/parties with ageing buckets
;          and totals, including dynamic field formatting and page layout.
;===============================================================================
...
;------------------------------------------------------------------------------
; (The rest of the report lines, totals, and field formatting follow as in original)
;------------------------------------------------------------------------------
