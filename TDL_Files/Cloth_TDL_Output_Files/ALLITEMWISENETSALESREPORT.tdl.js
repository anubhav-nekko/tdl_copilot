// Auto-generated from ALLITEMWISENETSALESREPORT.TXT
const tdl = `
;===============================================================================
; ALLITEMWISENETSALESREPORT.TXT
; Created By: Anil on 2024-03-19 12:57, ID:
; Purpose: Provides an "All Item Wise Net Sales Report" in Tally, showing net sales,
;          returns, collections, and related metrics per stock item, with filtering,
...
;------------------------------------------------------------------------------
; MAIN REPORT DEFINITION: All Item Wise Net Sales Report
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; MAIN DATA PART: REPEAT LINES FOR EACH STOCK ITEM
;------------------------------------------------------------------------------
...
[Part: PrtallItemwisenetsalesreport]
    ...
    repeat: LnallItemwisenetsalesreport: cwAllitemcollx
    scroll: Vertical
    Common Border: Yes
    Total: Qtyf, amtf, amtf1, amtf2, amtf3, amtf4, amtf5, numf, numf1, numf2, numf3, numf4, amtf20, amtf16, amtf12

;------------------------------------------------------------------------------
; COLLECTION: Stock items with non-zero sales out quantity
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; AGGREGATE COLLECTION: Net sales, returns, and collections by item
;------------------------------------------------------------------------------
...
[Collection: ColallItemwisenetsalesreport]
    ...
    aggr compute: cwsalesdiscamt1x2x: sum: if $$issales:$vouchertypename then (@@cwsalesdiscamt/@@cwinvamt)*@@salesinvamt2 else $$InitValue:"amount"
    aggr compute: cwcrnotediscamt1x2x: sum: if $$IsCreditNote:$vouchertypename then (@@cwsalesdiscamt/@@cwinvamt)*@@salesinvamt2 else $$InitValue:"amount"
...
;------------------------------------------------------------------------------
; MAIN DATA LINE: Item-wise net sales, returns, collections, etc.
;------------------------------------------------------------------------------
...
[Line: LnallItemwisenetsalesreport]
    ...
    local: field: numf: set as: $$reportobject:$$collectionfieldbykey:$salesbilledqty2x:#fwf:ColallItemwisenetsalesreport
    ...
    local: field: amtf12: set as: $$nettamount:@@salesinvamt1valueall2x:@@cwsalesdiscamt1xall2x
    ...
    local: field: numf2: set as: $$reportobject:$$collectionfieldbykey:$salescrbilledqty:#fwf:ColallItemwisenetsalesreport
