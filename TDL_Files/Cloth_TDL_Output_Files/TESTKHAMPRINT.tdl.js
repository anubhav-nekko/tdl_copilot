// Auto-generated from TESTKHAMPRINT.TXT
const tdl = `
;===============================================================================
; TESTKHAMPRINT.TXT
; Created By: khokan on 2022-04-22 16:38, ID:
; Purpose: Implements a custom "Test Kham Print" report in Tally, demonstrating
;          multi-ledger selection, advanced printing, bill-wise details, and
;          professional formatting with totals and page breaks.
;===============================================================================
...
[!menu: testkhamprintLock]
    add: Item: before: @@locQuit: @@testkhamprintReport: PRINT Collection: collRepmultiprintkhamprintx
...
;;------------------------------------------------------------------------------
;; LEDGER SELECTION: Popup for multi-ledger selection
;;------------------------------------------------------------------------------
...
[line: LntestkhamprintTitle1]
    field: fwf
    local: field: fwf: set as: "aaaaaaa"
...
;;------------------------------------------------------------------------------
;; MAIN DATA PART: Ledger and bill-wise details with page breaks
;;------------------------------------------------------------------------------
...
[part: LnmultiprintAGENTWISEoskhamx]
    ...
    repeat: LnmultiprintAGENTWISEOutstandingReportkhamx
    set: $$multiRepeatControlkham
    common border: yes

[Line: LnmultiprintAGENTWISEOutstandingReportkhamx]
    field: snf9, snf1, nf, Amtf, sdf2, nf1, amtf2, nf9
    Local: field: sdf: Width: 12
    Local: field: nf: Width: 20
    remove if: $$isempty:#amtf
    Option: Alter on Enter

    local: field: sdf: set as: $$CollectionField:$billdate:$$line:ColmultiprintAGENTWISEOutstandingReportakham
    local: field: Snf1: set as: $$string:@@cwbillDays2mpdate + $$string:"/" + $$string:@@CWbillMON2mpdate + $$string:"/" + $$string:@@CWbillYR2mpdate
    local: field: fwf: set as: $$CollectionField:$name:$$line:ColmultiprintAGENTWISEOutstandingReportakham
    local: field: nf: set as: $$CollectionField:$name:$$line:ColmultiprintAGENTWISEOutstandingReporta
    local: field: numf: set as: $$CollectionField:@@cwmultiduedays:$$line:ColmultiprintAGENTWISEOutstandingReportakham
    local: field: amtf: set as: $$CollectionField:$closingbalance:$$line:ColmultiprintAGENTWISEOutstandingReportakham
    local: field: sdf2: set as: $$CollectionField:$billdate:$$line:ColmultiprintAGENTWISEOutstandingReportbkham
    local: field: nf1: set as: $$CollectionField:$name:$$line:ColmultiprintAGENTWISEOutstandingReportbkham
    local: field: snf2: set as: $$CollectionField:@@cwModeofcreditmulti:$$line:ColmultiprintAGENTWISEOutstandingReportbkham
    local: field: amtf2: set as: $$CollectionField:$closingbalance:$$line:ColmultiprintAGENTWISEOutstandingReportbkham
...
;===============================================================================
; End of TESTKHAMPRINT.TXT (with documentation comments)
;===============================================================================
