/**
 * Net Sales Report TDL Definition
 * Converted from TXT to TDL.JS format
 * Original created by Khokan on 2021-05-17
 */

const tdlDefinition = `
;===============================================================================
;  Net Sales Report – original logic preserved, comments start with ";" only    ;
;  Created By: Khokan on 2021-05-17 12:37, ID:                                  ;
;===============================================================================


     [#menu: Gateway of Tally]
;; {09.Jul.21 14:05}         add: Option: NetsalesreportLock ;; : @@NetsalesreportDemoLock
...
by:cwledcity1:$cwledcity:ledger:$partyledgername
...
local:field: SNF: set as:$cwledcity1 ;;$$ReptField:Name:2:ledger:$partyledgername ;; "Area"
...
local:field: SNF: set as:$$CollectionField:$cwledcity1:First:ColNetsalesreport ;; "Area"
...
// Export the TDL definition
module.exports = {
  tdlDefinition
};

// Alternative export format if needed for direct browser use
// export const tdlDefinition = `...`;
