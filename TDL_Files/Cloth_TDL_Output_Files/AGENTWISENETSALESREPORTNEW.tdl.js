// Auto-generated from AGENTWISENETSALESREPORTNEW.TXT
const tdl = `
;===============================================================================
; AGENTWISENETSALESREPORTNEW.TXT
; Created By: Khokan on 2022-08-05 11:05, ID:
; Purpose: Provides an agent-wise net sales report in Tally, showing net sales,
;          sales returns, collections, and related metrics per party/agent.
;===============================================================================
...
;; {05.Aug.22 11:40}         add: Option: AGENTWISEnetsalesreportnewLock ;; : @@AGENTWISEnetsalesreportnewDemoLock

[#menu : cw_Debug_menu]
    add: Item: before: @@locQuit: @@AGENTWISEnetsalesreportnewReport: Display Collection: colllRepAGENTWISEnetsalesreportnew
    add: Item: before: @@locQuit: Blank

[!menu: AGENTWISEnetsalesreportnewLock]
    add: Item: before: @@locQuit: @@AGENTWISEnetsalesreportnewReport: Display Collection: colllRepAGENTWISEnetsalesreportnew
    add: Item: before: @@locQuit: Blank
...
[System: formula]
    AGENTWISEnetsalesreportnewReport:@@cwcaption1tableundernew+" "+"wise net sales report"
;; AGENTWISEnetsalesreportnewDemoLock: $$MachineDate < $$Date:"01/04/2013"

;------------------------------------------------------------------------------
; REPORT SELECTION COLLECTION: For party/ledger selection
;------------------------------------------------------------------------------

[Collection: colllRepAGENTWISEnetsalesreportnew]
    Use         : Extract Alias Collection
    Source Collection : List of Ledgers
    Variable    : LedgerName
    Report      : RepAGENTWISEnetsalesreportnew
    Trigger     : cwLedgerName1
    Fetch       : Name

;------------------------------------------------------------------------------
; MAIN REPORT DEFINITION: Agent-wise Net Sales Report
;------------------------------------------------------------------------------

[Report: RepAGENTWISEnetsalesreportnew]
    use: Dsp Template
    Title: @@AGENTWISEnetsalesreportnewReport
    Printset: Report Title: @@AGENTWISEnetsalesreportnewReport
    Form: FrmAGENTWISEnetsalesreportnew
    Export: Yes
...
[Form: FrmAGENTWISEnetsalesreportnew]
    use: DSP Template
    Part: DspAccTitles,PrtTitle0AGENTWISEnetsalesreportnew,PrtAGENTWISEnetsalesreportnew
    Width: 100% Page
    Height: 100% Page
;; Background: @@SV_STOCKSUMMARY
    delete: page break
    add: page break: AGENTWISEnetsalesreportnewbotbrk,AGENTWISEnetsalesreportnewbotOpbrk
...
[part: AGENTWISEnetsalesreportnewbotBrk]
    line: EXPINV PageBreak
    border: thin top

[part: AGENTWISEnetsalesreportnewbotopbrk]
    use: dspacctitles
    add: part: AGENTWISEnetsalesreportnewTitlePart

[part: AGENTWISEnetsalesreportnewTitlePart]
    line: LnAGENTWISEnetsalesreportnewTitle, LnAGENTWISEnetsalesreportnewTitle2

[line: LnAGENTWISEnetsalesreportnewCurrPeriod]
    field: fwf,fwf2
...
[part: PrtTitle0AGENTWISEnetsalesreportnew]
    line : LnAGENTWISEnetsalesreportnewCurrPeriod
...
[Part: PrtAGENTWISEnetsalesreportnew]
    Line: LnAGENTWISEnetsalesreportnewTitle, LnAGENTWISEnetsalesreportnewTitle2, LnAGENTWISEnetsalesreportnew
    bottom Line: LnAGENTWISEnetsalesreportnewTotals
    repeat: LnAGENTWISEnetsalesreportnew: ColAGENTWISEnetsalesreportnew
    scroll: Vertical
    Common Border: Yes
...
[Collection: ColAGENTWISEnetsalesreportnew]
    type: ledger
    child of: $$Groupsundrydebtors
    belongs to: yes
    fetch: cwcaption1item
    filter: ColAGENTWISEnetsalesreportnewFilter, cwColpartynameFilternew1

[system: Formula]
    ColAGENTWISEnetsalesreportnewFilter: ##LedgerName=$cwcaption1item

;------------------------------------------------------------------------------
; COLUMN HEADERS: Main and secondary title lines
;------------------------------------------------------------------------------

[Line: LnAGENTWISEnetsalesreportnewTitle]
    use: LnAGENTWISEnetsalesreportnew
    option: titleopt
...
[Line: LnAGENTWISEnetsalesreportnewTitle2]
    use: LnAGENTWISEnetsalesreportnew
    option: titleopt
...
[Line: LnAGENTWISEnetsalesreportnew]
    Fields: fwf
...
[line: LnAGENTWISEnetsalesreportnewTotals]
    use: LnAGENTWISEnetsalesreportnew
    option: totalOpt
