// Auto-generated from ALLAGENTWISEOUTSTANDINGREPORT.TXT
const tdl = `
;===============================================================================
; ALLAGENTWISEOUTSTANDINGREPORT.TXT
; Created By: Khokan on 2021-08-27 10:23, ID:
; Purpose: Provides an "All Agent Wise Outstanding Report" in Tally, showing
;          outstanding bills and credits for all agents/parties, with filtering,
...
;; {27.Aug.21 13:31}         add: Option: allAGENTWISEOutstandingReportLock ;; : @@allAGENTWISEOutstandingReportDemoLock
...
[System: formula]
    allAGENTWISEOutstandingReportReport: "All " + @@cwcaption1tableundernew + " wise outstanding report"
;; allAGENTWISEOutstandingReportDemoLock: $$MachineDate < $$Date:"01/04/2013"

;------------------------------------------------------------------------------
; MAIN REPORT DEFINITION: All Agent Wise Outstanding Report
;------------------------------------------------------------------------------
...
[Line: LnallAGENTWISEOutstandingReport]
    ...
    local: field: fwf: set as: $cwcaption1vch
...
;------------------------------------------------------------------------------
; SYSTEM FORMULAS: Filtering logic for agent/party selection
;------------------------------------------------------------------------------
...
cwcaption1itemagnt: $cwcaption1item:ledger:$parent
