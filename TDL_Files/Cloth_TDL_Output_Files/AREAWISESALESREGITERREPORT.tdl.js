// Auto-generated from AREAWISESALESREGITERREPORT.TXT
const tdl = `
;===============================================================================
; AREAWISESALESREGITERREPORT.TXT
; Created By: Khokan on 2021-08-25 18:35, ID:
; Purpose: Provides an "Area Wise Sales Register Report" in Tally,
;          listing sales vouchers by area/cost centre, with transport, area, LR details,
;          quantities, and gross amounts, including totals.
;===============================================================================

[#menu: Gateway of Tally]
;; {06.Sep.21 18:41}         add: Option: AREAWISEsalesregiterReportLock ;; : @@AREAWISEsalesregiterReportDemoLock
...
[System: formula]
    AREAWISEsalesregiterReportReport: @@cwcaption3tableundernew + " sales register report"
...
[system: Formula]
    ColAREAWISEsalesregiterReportFilter: $cwcaption3item:ledger:$partyledgername = ##SCostCentre
