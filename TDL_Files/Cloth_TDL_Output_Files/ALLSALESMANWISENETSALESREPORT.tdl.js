// Auto-generated from ALLSALESMANWISENETSALESREPORT.TXT
const tdl = `
;===============================================================================
; ALLSALESMANWISENETSALESREPORT.TXT
...
[System: formula]
    allSALESMANWISEnetsalesreportReport: "All " + @@cwcaption2tableundernew + " wise net sales report"
;; allSALESMANWISEnetsalesreportDemoLock: $$MachineDate < $$Date:"01/04/2013"

;------------------------------------------------------------------------------
; MAIN REPORT DEFINITION: All Salesman Wise Net Sales Report
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; COLLECTION: Aggregated net sales, returns, and collections by salesman/party
;------------------------------------------------------------------------------
...
[Line: LnallSALESMANWISEnetsalesreportTitle3]
    ...
    local: field: fwf: set as: $$CollectionField:$cwcaption1vch2:First:ColallSALESMANWISEnetsalesreport
...
;------------------------------------------------------------------------------
; MAIN DATA LINE: Salesman/party net sales, returns, collections, etc.
;------------------------------------------------------------------------------
...
add: explode: expsalesmWISEsalesRep: $$line = $$numitems or $cwcaption1vch2 <> $$nextobj:$cwcaption1vch2
