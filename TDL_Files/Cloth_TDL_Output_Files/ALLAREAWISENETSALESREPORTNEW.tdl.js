// Auto-generated from ALLAREAWISENETSALESREPORTNEW.TXT
const tdl = `
;===============================================================================
; ALLAREAWISENETSALESREPORTNEW.TXT
...
;------------------------------------------------------------------------------
; COLLECTION: Ledgers under Sundry Debtors with filters for area-wise grouping
;------------------------------------------------------------------------------
...
[Collection: ColallAREAWISEnetsalesReportnew]
    ...
    filter: cwcaption1netsalesvch3filter
...
[line: expareaWISEsalesRepnew]
    use: LnallAREAWISEnetsalesReportnew
    delete: explode
    local: field: fwf: set as: $$nextobj:$cwcaption3item
    local: field: nf: set as: ""
    Local: Field: NUMF: Set As: ""
    Local: Field: NUMF1: Set As: ""
    Local: Field: NUMF2: Set As: ""
