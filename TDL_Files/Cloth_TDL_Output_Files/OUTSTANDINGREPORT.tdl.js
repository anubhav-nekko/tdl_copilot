// Auto-generated from OUTSTANDINGREPORT.TXT
const tdl = `
; Created By: Khokan on 2021-02-10 12:02, ID:

;; ===================================================================
;; OUTSTANDING REPORT MODULE
;; ===================================================================
;; This module provides functionality to generate party-wise outstanding reports
;; showing debit and credit balances with aging information.
;; ===================================================================
...
;; {25.May.21 13:00}         add: Option: outstandingreportLock ;; : @@outstandingreportDemoLock
     ...
     ;; Define menu structure for outstanding report
     ...
     ;; Collection to extract ledger information for outstanding report
   ...
   ;; Auto-generated report for ledger name display
   [Report: LedgerNamex]   ;;Auto Report
            ...
            ;; Field definition for ledger name selection
            [Field: LedgerNamex]
          Use         : Name Field
          Key         : Create Ledger
          Modifies    : LedgerName
...
;; outstandingreportDemoLock: $$MachineDate < $$Date:"01/04/2013"
   ...
   Printset: Report Title: @@outstandingreportReport
     ...
     Export: Yes
     ;; Initialize date variables to current date
    ...
    ;; Main form for outstanding report display
    [Form: Frmoutstandingreport]
        use: DSP Template
...
;; Company information display settings
...
;; Button replacements for period and item changes
...
;; {16.May.22 14:51}       part:cwEXPINVPageBreak
  ...
  add: part: outstandingreportTitlePart
    ...
    ;; Collection for ledger address information
    ...
    ;; Current period line with ledger information
    ...
    ;; Title part with ledger information
    ...
    ;; Main report part with debit and credit sections
    ...
    ;; Debit section of the report (left side)
    [Part: PrtoutstandingreportA]
...
;; {09.Mar.22 11:41} field:sdf,amtf
    ...
    */
    ...
    ;; Credit section of the report (right side)
    [Part: PrtoutstandingreportB]
...
;; {02.Mar.22 11:02} local:field: snf: set as:if @@cwrecvchtype="Receipt" then (if not $$isempty:@@cwTransactionTypec  then @@cwTransactionTypec else "Cash") else @@cwModeofcredit
    ...
    /* Commented out credit total line
...
;; {08.Apr.22 15:47} use: LnoutstandingreportB
    ...
    */
    ...
    ;; Net total line for credit section
...
;; {08.Apr.22 16:02}  use: LnoutstandingreportTitle
    ...
    ;; Right summary part (credit totals)
    [Part: Prtoutstandingreport1B]
    ...
    ;; Empty line for alignment with net outstanding
    ...
    [part:Prtoutstandingreport2]           ; Main part for the outstanding report display
    part:Prtoutstandingreport2a        ; Includes sub-part for section A of the report
    part:Prtoutstandingreport2b        ; Includes sub-part for section B of the report

    [part:Prtoutstandingreport2a]      ; Definition of sub-part 2a
    line:LnoutstandingreportTotals    ; Displays total outstanding line in section A
    line:LnoutstandingreportTotalsnettolat ; Displays net total outstanding (latency?) in section A

    [part:Prtoutstandingreport2b]      ; Definition of sub-part 2b
    line:LnoutstandingreportTotalsB   ; Displays total outstanding line in section B
    line:LnoutstandingreportTotalsBNETTOTAL2 ; Displays net total outstanding (format 2) in section B
