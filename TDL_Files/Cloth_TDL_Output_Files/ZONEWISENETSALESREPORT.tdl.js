// Auto-generated from ZONEWISENETSALESREPORT.TXT
const tdl = `
;===============================================================================
; ZONEWISENETSALESREPORT.TXT
; Created By: Khokan on 2021-08-25 16:26, ID:
; Purpose: Implements a "Zone Wise Net Sales Report" in Tally, allowing users
;          to select a zone (cost centre) and view party-wise net sales, gross
;          sales, sales return, collection, and related details with advanced
;          filtering, grouping, and professional formatting.
;===============================================================================
...
[#menu: Gateway of Tally]
    ;; add: Option: ZONEwisenetsalesreportLock ;; : @@PartywisenetsalesreportDemoLock
...
[System: formula]
    ZONEwisenetsalesreportReport: @@cwcaption4tableundernew + " wise net sales report"
...
;;------------------------------------------------------------------------------
;; MAIN DATA PART: Table of party-wise net sales and related details
;;------------------------------------------------------------------------------
...
[system: Formula]
    ColZONEwisenetsalesreportFilter: $cwcaption1vch4 = ##SCostCentre
...
[Line: LnZONEwisenetsalesreportTitle]
    ...
    local: field: grSRIN: set as: "Gross Sales Return"
...
[Line: LnZONEwisenetsalesreport]
    ...
    local: field: numf2: set as: $$reportobject:$$collectionfieldbykey:$billedqty:@@ZONEkeycrnotenew:cwColNetcrnotereportZONE
    local: field: amtf2: set as: $$reportobject:$$collectionfieldbykey:$amount1:@@ZONEkeycrnotenew:cwColNetcrnotereportZONE
    local: field: numf3: set as: #numf - #numf2
    local: field: amtf3: set as: #amtf - #amtf2
    local: field: amtf4: set as: if $$isempty:@@cwcrnoteamount then $amount else $amount - @@cwcrnoteamountZONE
    local: field: amtf5: set as: $$reportobject:$$collectionfieldbykey:$rcptvalue:@@ZONEkeycrnotenew:ColreceiptZONE
...
[System: Formula]
    ZONEkeycrnotenew: #fwf

;;------------------------------------------------------------------------------
;; CREDIT NOTE AND RECEIPT COLLECTIONS FOR NET CALCULATIONS
;;------------------------------------------------------------------------------
...
;===============================================================================
; End of ZONEWISENETSALESREPORT.TXT (with documentation comments)
;===============================================================================
