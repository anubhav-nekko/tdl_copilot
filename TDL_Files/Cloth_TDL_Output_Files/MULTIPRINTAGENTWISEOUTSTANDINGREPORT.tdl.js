// Auto-generated from MULTIPRINTAGENTWISEOUTSTANDINGREPORT.TXT
const tdl = `
; Created By: Khokan on 2021-08-28 13:12, ID: 

/**
 * AGENT-WISE OUTSTANDING REPORT MODULE
 * 
 * This module implements an Agent-wise Outstanding Statement report in Tally.
 * The report displays outstanding balances for agents, showing both debit and credit entries
 * with details like bill dates, due days, and amounts.
 * 
 * Original configuration section below is preserved for reference.
 */
    /*
 ...
 * Adds the report option to the Gateway of Tally menu
 */
 ...
 * Adds the report to the debug menu for testing purposes
 */
     [#menu : cw_Debug_menu]   
...
/**
 * Report Menu Configuration
 * Defines the menu structure for the Agent-wise Outstanding Report
 * Includes options for displaying and printing the report
 */
 ...
 * Defines the report title by combining the agent type with "wise O/S Statement"
 */
    [System: formula]
...
/**
 * Collection Definition for Report
 * This collection extracts ledger names to be used in the report
 * Acts as the main data source for the report
 */
 ...
 * Configures the Agent-wise Outstanding Report with template, title, and form settings
 */     
    [Report: RepmultiprintAGENTWISEOutstandingReport]
        use: Dsp Template
...
/**
 * Form Definition for the Report
 * Configures the layout, dimensions, and components of the report form
 */
      [Form: FrmmultiprintAGENTWISEOutstandingReport]
        use: DSP Template
...
/**
 * Company Information Display Configuration
 * Sets up the display of company name, address, and report title with appropriate styling
 */
...
/**
 * Style Definitions
 * Defines text styles used throughout the report
 */
[style:style3n]
font:"timesnewroman"
height:14
 ...
 * Defines the bottom page break with border
 */
 ...
 * Creates an empty line for spacing purposes
 */
...
/**
 * Report Title Part Configuration
 * Adds the title part to the report
 */
 ...
 * Configures the title section with company name and report title
 */
...
/**
 * Conditional Title Part Configuration
 * Removes the title line when specific conditions are met
 */
...
/**
 * Empty Line Definition
 * Creates an empty line for spacing in the report
 */      
...
/**
 * Title Part Definition
 * Alternative configuration for the report title section
 */
 ...
 * Configures the appearance and alignment of company name and report title
 */
        local:line:DSPCompanyName: Local: Field: DSP CompanyName:PrintStyle:styleCalisto2
       local:line:DSPReportName: Local: Field: DSPReportName:PrintStyle:styleCalisto
       local:line:DSPReportName: Local: Field: DSPReportName:Align:RIGHT
...
/**
 * Current Period Line Configuration
 * Sets up the display of the current date period in the report
 */       
 ...
 * Configures the section that displays agent information
 */      
      [part:multiagentpart]
      line:multiprintAGENTline  ;;,multiprintagenTaddress,multiprintagenTaddress2  ;;,multipagentpartyphline

/**
 * Agent Line Configuration
 * Sets up the display of agent name with appropriate styling
 */      
 ...
 * Configures the main section that displays outstanding entries
 */      
...
/**
 * Main Data Collection Definition
 * Configures the collection that retrieves ledger data for the report
 */
...
/**
 * Filter Formulas
 * Defines conditions for filtering data in the report
 */
[System: Formula]
...
/**
 * Debit Bills Collection
 * Collection for retrieving bills with debit balances
 */
 ...
 * Collection for retrieving bills with credit balances
 */
...
/**
 * Filter Formulas for Bills
 * Defines conditions for filtering debit and credit bills
 */
 [system: Formula]
...
/**
 * Multi-ledger Line Configuration
 * Sets up the display of ledger entries with appropriate styling
 */
 [line:multiledger]
...
/**
 * Multi-ledger Option Configuration
 * Conditional configuration based on specific parameter
 */
...
/**
 * Ledger Address Part
 * Configures the display of ledger address information
 */ 
 ...
 * Sets up the display of the first line of address
 */
...
/**
 * Second Address Line Configuration
 * Sets up the display of the second line of address
 */
...
/**
 * Phone Information Line Configuration
 * Sets up the display of phone and mobile numbers
 */
...
/**
 * Ledger Address Collection
 * Collection for retrieving address information for ledgers
 */
...
/**
 * Outstanding Statement Part
 * Configures the section that displays outstanding statement details
 */
 ...
 * Function to determine the number of rows to display based on debit and credit counts
 */
 ...
 * Configures the header row for the outstanding statement
 */
...
/**
 * System Formulas for Outstanding Report
 * Defines calculations for due days and credit mode display
 */
[System: Formula]
...
/**
 * Outstanding Report Detail Line
 * Configures the data rows for the outstanding statement
 */
 ...
 * Sets up the display of amount values with appropriate calculations
 */
 ...
 * Calculates running totals for debit and credit amounts
 */
...
/**
 * Field Styling and Visibility
 * Sets the style for fields and hides calculation fields
 */
...
/**
 * Subtotal Part Configuration
 * Configures the display of subtotals at the end of each agent section
 */
[part:cwmultisubtotal]
line:cwmultisubtotalline
border:thin top

/**
 * Subtotal Line Configuration
 * Sets up the display of debit and credit subtotals
 */
[line:cwmultisubtotalline]
field:fwfc,amtf,amtf2

Local: Field: fwfc: Set As:"Total"
Local: Field: amtf: Set As:$$CollAmtTotal:ColmultiprintAGENTWISEOutstandingReporta:$closingbalance
Local: Field: amtf2: Set As:$$CollAmtTotal:ColmultiprintAGENTWISEOutstandingReportb:$closingbalance

local: field: fwfc : style:styleCalisto2
local: field: amtf : style:styleCalisto2
local: field: amtf2 : style:styleCalisto2
