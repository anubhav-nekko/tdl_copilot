// Auto-generated from ALLSALESMANWISENETSALESREPORTNEW.TXT
const tdl = `
;===============================================================================
; ALLSALESMANWISENETSALESREPORTNEW.TXT
; Created By: Khokan on 2022-08-08 12:07, ID:
; Purpose: Provides an "All Salesman Wise Net Sales Report" in Tally,
;          showing net sales, returns, collections, and related metrics
;          per salesman/party, with filtering, grouping, and aggregation.
;===============================================================================

[#menu: Gateway of Tally]
;; {09.Aug.22 10:16}         add: Option: allSALESMANWISEnetsalesreportnewLock ;; : @@allSALESMANWISEnetsalesreportnewDemoLock

[#menu : cw_Debug_menu]
    add: Item: before: @@locQuit: @@allSALESMANWISEnetsalesreportnewReport: Display: RepallSALESMANWISEnetsalesreportnew

[!menu: allSALESMANWISEnetsalesreportnewLock]
    add: Item: before: @@locQuit: @@allSALESMANWISEnetsalesreportnewReport: Display: RepallSALESMANWISEnetsalesreportnew
    add: Item: before: @@locQuit: Blank

[System: formula]
    allSALESMANWISEnetsalesreportnewReport: "All " + @@cwcaption2tableundernew + " wise net sales report"
;; allSALESMANWISEnetsalesreportnewDemoLock: $$MachineDate < $$Date:"01/04/2013"

[Report: RepallSALESMANWISEnetsalesreportnew]
    use: Dsp Template
    Title: @@allSALESMANWISEnetsalesreportnewReport
    Printset: Report Title: @@allSALESMANWISEnetsalesreportnewReport
    Form: FrmallSALESMANWISEnetsalesreportnew
    Export: Yes
...
[Form: FrmallSALESMANWISEnetsalesreportnew]
    use: DSP Template
    Part: DspAccTitles, PrtTitle0allSALESMANWISEnetsalesreportnew, PrtallSALESMANWISEnetsalesreportnew
    Width: 100% Page
    Height: 100% Page
    delete: page break
    add: page break: allSALESMANWISEnetsalesreportnewbotbrk, allSALESMANWISEnetsalesreportnewbotOpbrk
...
[part: allSALESMANWISEnetsalesreportnewbotBrk]
    line: EXPINV PageBreak
    border: thin top

[part: allSALESMANWISEnetsalesreportnewbotopbrk]
    use: dspacctitles
    add: part: allSALESMANWISEnetsalesreportnewTitlePart

[part: allSALESMANWISEnetsalesreportnewTitlePart]
    line: LnallSALESMANWISEnetsalesreportnewTitle, LnallSALESMANWISEnetsalesreportnewTitle2

[line: LnallSALESMANWISEnetsalesreportnewCurrPeriod]
    field: fwf, fwf2
...
[part: PrtTitle0allSALESMANWISEnetsalesreportnew]
    line: LnallSALESMANWISEnetsalesreportnewCurrPeriod

[Part: PrtallSALESMANWISEnetsalesreportnew]
    Line: LnallSALESMANWISEnetsalesreportnewTitle, LnallSALESMANWISEnetsalesreportnewTitle2, LnallSALESMANWISEnetsalesreportnewTitle3, LnallSALESMANWISEnetsalesreportnew
    bottom Line: LnallSALESMANWISEnetsalesreportnewTotals
    repeat: LnallSALESMANWISEnetsalesreportnew: ColallSALESMANWISEnetsalesreportnew
    scroll: Vertical
    Common Border: Yes
    Total: Qtyf, amtf, amtf1, amtf2, amtf3, amtf4, amtf5, numf, numf1, numf2, numf3, numf4, amtf20, amtf16

[line: LnallSALESMANWISEnetsalesreportnewTitle]
    use: LnallSALESMANWISEnetsalesreportnew
    option: titleopt
...
[line: LnallSALESMANWISEnetsalesreportnewTitle2]
    use: LnallSALESMANWISEnetsalesreportnew
    option: titleopt
...
[line: LnallSALESMANWISEnetsalesreportnewTitle3]
    use: LnallSALESMANWISEnetsalesreportnew
    local: field: fwf: set as: $$CollectionField:$cwcaption2item:First:ColallSALESMANWISEnetsalesreportnew
...
[Collection: ColallSALESMANWISEnetsalesreportnew]
    type: ledger
    child of: $$Groupsundrydebtors
    belongs to: yes
    filter: cwColpartyFilter
    filter: cwnetsalesmannewfilternew, cwColpartynameFilternew1
    fetch: cwcaption2item
    sort: @@default: $cwcaption2item

[System: Formula]
    ColallSALESMANWISEnetsalesreportnewFilter: Yes
    cwnetsalesmannewfilternew: if $$issysname:##str2 then yes else $cwcaption2item = ##str2
    cwColpartynameFilternew1: if $$issysname:##str1 then yes else $name = ##str1

[Line: LnallSALESMANWISEnetsalesreportnew]
    Fields: fwf
...
add: explode: expSALESMANWISEsalesRepnew: $$line = $$numitems or $cwcaption2item <> $$nextobj:$cwcaption2item

[part: expSALESMANWISEsalesRepnew]
    line: expSALESMANWISEsalesRepnew

[line: expSALESMANWISEsalesRepnew]
    use: LnallAGENTWISEnetsalesreportnew
    delete: explode
    local: field: fwf: set as: $$nextobj:$cwcaption2item
    local: field: nf: set as: ""
    Local: Field: NUMF: Set As: ""
    Local: Field: NUMF1: Set As: ""
    Local: Field: NUMF2: Set As: ""
...
[line: LnallSALESMANWISEnetsalesreportnewTotals]
    use: LnallSALESMANWISEnetsalesreportnew
    option: totalOpt
...
[button: allsalesmannetsalesbotton]
    key: f7
    title: "Filter"
    Action: Modify Variables: allsalesmannetsalesbotton

[report: allsalesmannetsalesbotton]
    form: allsalesmannetsalesbotton

[form: allsalesmannetsalesbotton]
    part: allsalesmannetsalesbotton
    HEIGHT: 20
    WIDTH: 30

[part: allsalesmannetsalesbotton]
    line: cwtitlelinex, agentbotton, allsalesmannetsalesbotton

[line: allsalesmannetsalesbotton]
    field: sp, nf
