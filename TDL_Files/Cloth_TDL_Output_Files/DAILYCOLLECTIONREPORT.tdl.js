// Auto-generated from DAILYCOLLECTIONREPORT.TXT
const tdl = `
;===============================================================================
; DAILYCOLLECTIONREPORT.TXT
; Created By: Khokan on 2021-06-10 16:10, ID:
; Purpose: Provides a "Daily Collection Report" in Tally,
;          showing all receipt vouchers for the day, with party, cheque, and amount details.
;===============================================================================
...
[Line: LnDailyCollectionReport]
    ...
    option: alter on enter
    local: field: fwf: alter: voucher: $$isvoucher
    Local: Field: nf: Set As: $baknname1
    local: field: sdf: set as: $date
    local: field: snf: set as: $vouchernumber
    local: field: snf2: set as: $$ReptField:Name:2:ledger:#fwf
    local: field: snf3: set as: $AllLedgerEntries[1, @@IsBankLedgr].BankAllocations[1].InstrumentNumber
