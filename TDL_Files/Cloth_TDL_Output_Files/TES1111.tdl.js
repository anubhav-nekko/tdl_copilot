// Auto-generated from TES1111.TXT
const tdl = `
;===============================================================================
; TES1111.TXT
; Created By: khokan on 2022-05-26 16:10, ID:
; Purpose: Implements a custom report "tes1111" in Tally, demonstrating
;          receipt filtering, grouping, and reporting with period setup and
...
;;------------------------------------------------------------------------------
;; DATA COLLECTIONS: Receipts grouped and filtered by party/group
;;------------------------------------------------------------------------------
...
[System: Formula]
    ...
    ;; cwcashreceiptfilterxx3: not $parent:ledger:$partyledgername="Sundry Creditors"
...
;===============================================================================
; End of TES1111.TXT (with documentation comments)
;===============================================================================
