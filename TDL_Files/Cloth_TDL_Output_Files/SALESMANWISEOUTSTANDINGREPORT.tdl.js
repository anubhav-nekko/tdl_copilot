// Auto-generated from SALESMANWISEOUTSTANDINGREPORT.TXT
const tdl = `
;===============================================================================
; SALESMANWISEOUTSTANDINGREPORT.TXT
; Created By: Khokan on 2021-08-24 11:57, ID:
; Purpose: Implements a "Salesman Wise Outstanding Report" in Tally, showing
;          party/bill-wise outstanding receivables grouped by salesman, with
;          Dr/Cr breakup, due days, and totals, supporting audit and collection.
;===============================================================================
...
[#menu: Gateway of Tally]
    ...
    ;; add: Option: SalesmanTWISEOutstandingReportLock ;; : @@AGENTWISEOutstandingReportDemoLock
...
[System: Formula]
    mycwcwcaption2table:$parent=@@cwcaption2tableundernew
    SalesmanTWISEOutstandingReportReport: @@cwcaption2tableundernew+" "+"wise outstanding report"
...
;;------------------------------------------------------------------------------
;; MAIN DATA PART: Dr Side (Debit Outstanding)
;;------------------------------------------------------------------------------
...
[system: Formula]
    ColSalesmanTWISEOutstandingReportFilter:$$isdr:$closingbalance and $cwcaption2vch=##LedgerName
...
;;------------------------------------------------------------------------------
;; TOTALS LINES: Dr Total and Net Outstanding
;;------------------------------------------------------------------------------
...
;;------------------------------------------------------------------------------
;; MAIN DATA PART: Cr Side (Credit Outstanding)
;;------------------------------------------------------------------------------
...
[system: Formula]
    ColSalesmanTWISEOutstandingReportFilterb:not $$isdr:$closingbalance and $cwcaption2vch=##LedgerName
...
;===============================================================================
; End of SALESMANWISEOUTSTANDINGREPORT.TXT (with documentation comments)
;===============================================================================
