// Auto-generated from LRPENDINGUPATEREPORT.TXT
const tdl = `
;===============================================================================
; LRPENDINGUPATEREPORT.TXT
; Created By: Khokan on 2021-08-24 18:34
; Purpose: Provides an "LR Pending Report" in Tally, listing sales vouchers
;          where the Lorry Receipt (LR) number is missing, along with key
;          dispatch, transporter, and invoice details for follow-up.
;===============================================================================

; Add menu option for the LR Pending Report in Gateway of Tally
[#menu: Gateway of Tally]
;; {24.Aug.21 19:26}         add: Option: LRPendingReportLock ;; : @@LRPendingReportDemoLock

; Add the report option to the debug menu
[#menu : cw_Debug_menu]
    add: Item: before: @@locQuit: @@LRPendingReportReport: alter: RepLRPendingReport
    add: Item: before: @@locQuit: @@LRPendingReportReport: alter: RepLRPendingReport
    add: Item: before: @@locQuit: Blank

; Define custom formula strings for use in titles and conditions
[System: formula]
...
[Report: RepLRPendingReport]
    ...
    multiobjects: ColLRPendingReport  ; Use collection defined below

; Define the form layout for LR Pending Report
[Form: FrmLRPendingReport]
    use: DSP Template
...
; Footer part of report with page break
[part: LRPendingReportbotBrk]
    line: EXPINV PageBreak
    border: thin top

; Top part repeated on each page with titles
...
; Add current period to the report form
[part: PrtTitle0LRPendingReport]
    line : LnLRPendingReportCurrPeriod

; Main part for displaying report details
...
; Filter: only sales vouchers with missing LR numbers and having transporter details
[system: Formula]
...
[Line: LnLRPendingReport]
    ...
    ; Storage definitions for LR details
