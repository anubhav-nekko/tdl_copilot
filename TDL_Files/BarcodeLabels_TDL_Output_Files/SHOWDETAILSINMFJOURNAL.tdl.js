// Auto-generated from SHOWDETAILSINMFJOURNAL.TXT
const tdl = `
;===============================================================================
; SHOWDETAILSINMFJOURNAL.TXT
; Created By: prakash on 2022-04-14 10:30, ID:
; Purpose: Adds a "Details" button and subform to Manufacturing Journal (Stock Journal)
;          vouchers in Tally, allowing users to view (and potentially edit) batch
;          details such as custom captions, godown, quantity, and amount for each
;          inward inventory entry.
;===============================================================================

;------------------------------------------------------------------------------
; (COMMENTED) Option to show batch details in manufacturing journal line
;------------------------------------------------------------------------------

;; [#Line: SJ MfdBatch]
;; add : option : cwshowMfgBatchDetails: $$IsBatchWiseOn and @@HasBatchWise and $cwbarcodeeachqty:COMPANY:##SVCURRENTCOMPANY
...
;------------------------------------------------------------------------------
; Add "Details" button to voucher form (display mode)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Batch details subform report and form
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Main part and lines for inventory entries (inwards)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Batch details explosion part and line
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; (COMMENTED) Field accept/update logic for batch captions
;------------------------------------------------------------------------------

;; local : field : nf2 : on : accept : yes : field accept
;; local : field : nf2 : on : accept : yes : call: cwUpdBatch:#numf:1:$$value
;; local : field : nf3 : on : accept : yes : field accept
;; local : field : nf3 : on : accept : yes : call: cwUpdBatch:#numf:2:$$value
;; local : field : nf4 : on : accept : yes : field accept
;; local : field : nf4 : on : accept : yes : call: cwUpdBatch:#numf:3:$$value

;------------------------------------------------------------------------------
; Totals part (optional)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; (COMMENTED) Function to update batch captions in voucher object
;------------------------------------------------------------------------------
