// Auto-generated from testrep.txt
const tdl = `
;===============================================================================
; TESTREP.TXT
; Created By: Khokan on 2024-11-22 14:54, ID:
; Purpose: Provides a test report in Tally that lists batches with negative stock
;          balances, allows voucher drilldown, and supports range filtering and view options.
;===============================================================================

;------------------------------------------------------------------------------
; (Optional) Add test report option to Gateway of Tally menu
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Main collection: batches with negative closing balance
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Main data line: batch details with negative stock
;------------------------------------------------------------------------------
