// Auto-generated from STOCKSUMMARYADDCUSTOMIZEDFIELDS.TXT
const tdl = `
;===============================================================================
; STOCKSUMMARYADDCUSTOMIZEDFIELDS.TXT
; Created By: pg on 2022-03-25 12:27, ID:
; Purpose: Adds up to 12 custom item fields and 3 custom batch fields as columns
;          in the Stock Summary report in Tally, with dynamic captions and
;          company-level configuration.
;===============================================================================

;------------------------------------------------------------------------------
; Extend Stock Summary form to include custom fields and batch fields as columns
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Function: Count number of columns in Stock Summary (Opening, Inwards, Outwards, Closing)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Add custom item fields to Stock Summary lines if enabled
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Add custom batch fields to Stock Summary batch explosion part if enabled
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Set captions and values for batch fields in batch explosion
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Field definitions for custom item fields (up to 12)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Field definitions for custom batch fields (up to 3)
;------------------------------------------------------------------------------
