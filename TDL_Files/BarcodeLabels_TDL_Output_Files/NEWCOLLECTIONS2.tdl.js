...
;===============================================================================
; NEWCOLLECTIONS2.TXT
; Created By: Anil on 2023-07-18 17:35, ID:
; Created By: Akshay on 2013-01-29 17:57, ID:
; Purpose: Defines dynamic collections and field key options for attribute-based
;          tables (brand, style, season, size, color, etc.) in Tally, supporting
;          up to 14 user-defined levels with captions and flexible configuration.
;===============================================================================
...
;------------------------------------------------------------------------------
; The pattern continues for lines 9–14, each using @@forunderN and dynamic titles.
;------------------------------------------------------------------------------
...
; (Collections for lines 10–14 follow the same structure as above, with the appropriate @@forunderN and Title assignments.)
