...
; Purpose: Declares all custom UDFs (User Defined Fields) and related formulas
;          required for the Barcode Labels module and advanced inventory features.
;===============================================================================

;------------------------------------------------------------------------------
; SYSTEM UDF DECLARATIONS FOR ITEM ATTRIBUTES, CONFIG, AND BATCH FIELDS
;------------------------------------------------------------------------------

[System: UDF]
;; <StorageName> : <Data Type> : <Storage Location>

;--- Item attribute UDFs (brand, size, product, etc.) ---
...
;--- Custom field enablement and captions ---
...
;--- Additional product UDFs for extended attributes ---
...
;--- Table and grouping configuration UDFs for custom fields ---
...
;--- Costing and barcode configuration UDFs ---
...
;--- Scene/item image and image path UDFs ---
...
;--- Miscellaneous UDFs ---
cwline : number : 1040 ; to store line no in inventory entries
...
;------------------------------------------------------------------------------
; SYSTEM FORMULAS FOR CUSTOM FIELD ENABLEMENT AND STOCK SUMMARY DISPLAY
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; ADDITIONAL UDFS FOR TRANSFER DETAILS (ADDON MODULES)
;------------------------------------------------------------------------------
