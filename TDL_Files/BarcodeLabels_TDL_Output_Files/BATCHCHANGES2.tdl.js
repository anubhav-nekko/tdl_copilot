...
; Purpose: Adds advanced batch-level configuration and custom field support for
;          barcode, MRP, image, and additional captions in Tally.
;===============================================================================

;;----------------- Features Changes -------------------------

;------------------------------------------------------------------------------
; Batch configuration line for barcode, MRP, image, and image path options
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Batch custom field captions and show-in-stock-summary options
;------------------------------------------------------------------------------

[Line: lncmpbatchfieldcaption]
;; {14.Jul.23 12:34} Invisible: yes
space top:.5
...
;------------------------------------------------------------------------------
; System formulas for enabling batch fields, captions, and options
;------------------------------------------------------------------------------
