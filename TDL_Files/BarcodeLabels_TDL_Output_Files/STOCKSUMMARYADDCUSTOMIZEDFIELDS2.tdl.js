// Auto-generated from STOCKSUMMARYADDCUSTOMIZEDFIELDS2.TXT
const tdl = `
;===============================================================================
; STOCKSUMMARYADDCUSTOMIZEDFIELDS2.TXT
; Created By: Anil on 2023-07-12 16:26, ID:
; Created By: pg on 2022-03-25 12:27, ID:
; Purpose: Adds custom fields and batch fields to the Stock Summary report in Tally,
;          supporting up to 14 user-defined item fields and 12 batch fields, with
;          dynamic captions and integration into the stock summary UI.
;===============================================================================

;------------------------------------------------------------------------------
; Add options to Stock Summary form for showing item and batch custom fields
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Function to count the number of columns in Stock Summary (used for layout control)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Add item custom fields to Stock Summary item lines if enabled
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Add batch custom fields to Stock Summary batch explosion part if enabled
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Set captions and values for batch custom fields in Stock Summary batch lines
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Field definitions for item custom fields (1–12)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Field definitions for batch custom fields (1–12)
;------------------------------------------------------------------------------
